...
public class TranslucentFrame {
    ...
    public static void main(String[] args) {
        ...
        new TranslucentFrame(250, 180, 10, 4, title, message).popup();
    ...
    public void print() {
        ...
        // 设置窗体的位置及大小
        int x = Toolkit.getDefaultToolkit().getScreenSize().width - Toolkit.getDefaultToolkit().getScreenInsets(frame.getGraphicsConfiguration()).right - width
                - 5;
        int y = Toolkit.getDefaultToolkit().getScreenSize().height - Toolkit.getDefaultToolkit().getScreenInsets(frame.getGraphicsConfiguration()).bottom
                - height - 5;
